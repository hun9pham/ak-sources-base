...
#else
#define UART_TERMINAL_CLOCK               	( RCC_APB1Periph_USART2 )
#define UART_TERMINAL                     	( USART2 )
#define UART_TERMINAL_IRQn                	( USART2_IRQn )
#define UART_TERMINAL_BAUD            		( 115200 )
...
#define TERMINAL_BUFFER_LETTER_READ_SIZE    (32)
