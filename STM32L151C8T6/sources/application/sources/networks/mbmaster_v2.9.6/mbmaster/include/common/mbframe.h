...
#define MB_SER_BROADCAST_ADDR_ADD   ( 255 )       /*!< MODBUS serial broadcast address. */
#define MB_SER_SLAVE_ADDR_MIN       ( 1 )       /*!< Smallest valid serial address. */
#define MB_SER_SLAVE_ADDR_MAX       ( 254 )     /*!< Biggest valid serial address. */
#define MB_ANY_ADDR                 ( 255 )     /*!< Special address sometimes used in csModbus/TCP. */
...
#define MB_IS_VALID_WRITE_ADDR( ucAddr ) \
    ( ( ( ucAddr ) == MB_SER_BROADCAST_ADDR ) || ( ( ucAddr ) == MB_SER_BROADCAST_ADDR_ADD ) || MB_IS_VALID_READ_ADDR( ucAddr ) )
