...
#define OB_BOOT_BANK2                  ((uint8_t)0x00) /*!< At startup, if app pins are set in app from user Flash position
                                                            and this parameter is selected the device will app from Bank 2 
                                                            or Bank 1, depending on the activation of the bank */
#define OB_BOOT_BANK1                  ((uint8_t)0x80) /*!< At startup, if app pins are set in app from user Flash position
                                                            and this parameter is selected the device will app from Bank1(Default) */
